...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_LS_CAPS]  = ACTION_TAP_DANCE_DOUBLE(KC_LSFT, KC_CAPS),
  [TD_OS_ALT]  = ACTION_TAP_DANCE_DOUBLE(KC_LGUI, KC_LALT)
 ...
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | LS,CL|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  | Shift|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      | Alt  |OS,Alt| Ctrl | Raise|Lower | Space| Enter| CpsL |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_plaid_grid(
    KC_ESC, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSPC,
    KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_BSLS,
    TD(TD_LS_CAPS), KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
    KC_NO, KC_NO, KC_LALT, TD(TD_OS_ALT), KC_LCTL, RAISE, LOWER, KC_SPC, KC_ENT, KC_CAPS, KC_NO, KC_NO
),
 ...
 * |      |      |      |      |      |      | Left | Down |  Up  | Rght |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | LShft|      |      |      |      |      | OS1  | OS2  | OS3  | OS4  | OS5  | RShft|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |  OS  | Ctrl | Combo|Lower |      |      |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT_plaid_grid(
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_INS, KC_DEL,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_NO, KC_NO,
    KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, LGUI(KC_1), LGUI(KC_2), LGUI(KC_3), LGUI(KC_4), LGUI(KC_5), KC_RSFT,
    KC_NO, KC_NO, KC_NO, KC_LGUI, KC_LCTL, _______, _______, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
),
 ...
 * | LShft|      |      |      |      |      |      |   -  |   =  |   [  |   ]  | RShft|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      |      |      |      |      | Raise|Combo | RCtrl| RAlt |      |      |      |
 * `-----------------------------------------------------------------------------------'
 */
[_RAISE] = LAYOUT_plaid_grid(
    KC_F12, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11,
    KC_GRV, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_QUOT,
    KC_LSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_RSFT,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, _______, _______, KC_RCTL, KC_RALT, KC_NO, KC_NO, KC_NO
),

/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * | PtScr| LED1 | LED2 | LED3 | LED4 | LED5 | LED6 | LED7 | LED8 | LED9 | LED0 |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | kana |      |      |      |      | Reset| Vol+ | Mute |      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * | hi/ka|      |      |      |      |      | Vol- |      |      |      |      |      |
...
[_ADJUST] = LAYOUT_plaid_grid(
    KC_PSCR, LED_1, LED_2, LED_3, LED_4, LED_5, LED_6, LED_7, LED_8, LED_9, LED_0, KC_NO,
    KC_LANG1, KC_NO, KC_NO, KC_NO, KC_NO, RESET, KC_VOLU, KC_MUTE, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_KANA, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_VOLD, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
